...
export const ACTION_LABELS: Record<string, string> = {
  ...
  "approval.acknowledge": "사후보고 확인",
  "approval.feedback": "사후보고 피드백",
  "engagement_plan.post_report": "섭외 확정 (사후보고)",
  "engagement_plan.feedback": "섭외 사후보고 피드백 기록",
  "tenant.post_report_mode": "사후보고 모드 설정 변경",
  ...
  "project.update_basic": "프로젝트 기본정보 수정",
  "project.archive": "프로젝트 보관(취소) 처리",
  "project.delete_empty": "빈 프로젝트 삭제",
  "slot.duplicate": "세션 복사",
  "settlement_attachment.upload": "종료 증빙 첨부",
  "settlement_attachment.delete": "종료 증빙 삭제",
  "settlement_attachment.view": "종료 증빙 열람",
  "project_step.status_change": "스텝 상태 변경",
  "message.send": "발송 실행",
  "export.experts": "전문가 목록 내보내기",
  "export.experts_global": "전문가 DB 전체 내보내기 (관리모드)",
  "expert.activate": "전문가 이용 재개",
  "expert.deactivate": "전문가 이용 중지",
  ...
  "account.invite_sent": "계정 발급 메일 발송",
  "account.invite_resent": "계정 발급 메일 재발송",
  "account.invite_failed": "계정 발급 메일 실패",
  "account.reset_email_sent": "비밀번호 재설정 메일 발송 (관리모드)",
  "account.reset_email_failed": "비밀번호 재설정 메일 실패 (관리모드)",
  "account.temp_password_issued": "임시 비밀번호 발급 (관리모드)",
