...
export const GRADE_DESCRIPTIONS: Record<UserGrade, string> = {
  ...
  team_lead: "배정 프로젝트에서 전 기능 실행 + 레벨 4에 없는 4가지 — 프로젝트 개설, 보유자료 일괄 등록, 섭외 취소, 문자 자유 발송. PL은 이 레벨부터(기본값)",
  deputy: "배정 프로젝트에서 섭외요청·수락서·안내문자·지급건 생성 등 실행. 개설·일괄 등록·섭외 취소·자유 문자는 불가. PM은 이 레벨부터(기본값)",
