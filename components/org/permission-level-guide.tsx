...
const LEVEL_ROWS: { level: string; who: string; can: string[] }[] = [
  ...
  },
  {
    ...
    can: [
      ...
      "레벨 4에는 없는 4가지 — 프로젝트 개설 · 보유자료 일괄 등록 · 섭외 취소 · 문자 자유 발송",
    ],
  },
  {
    level: "레벨 4",
    who: "실무 책임 — PM·부PM은 이 레벨부터",
    can: [
      "배정된 프로젝트에서 레벨 3의 대부분 기능 실행 — 섭외요청 발송, 수락서, 세션 안내문자, 지급건 생성, 전문가 평가·서류 요청",
      "안 되는 것 4가지 — 프로젝트 개설, 보유자료 일괄 등록, 섭외 취소, 문자 자유 발송 (레벨 3 이상에게 요청)",
    ],
  },
  {
    level: "레벨 5",
      ...
      <div className="space-y-4 px-4 pb-4 text-sm leading-relaxed text-[#33405A]">
        ...
        <div>
          ...
          <ul className="list-disc space-y-1 pl-5">
            ...
            <li>
              ...
              책임입니다. 역할에는 최소 레벨이 있습니다 — <b>PL은 레벨 3 이상,
              PM·부PM은 레벨 4 이상</b>만 지정할 수 있습니다.
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="list-disc space-y-1 pl-5">
            <li>
              ...
              <b>사람마다 켜고 끌 수 있습니다</b> (설정 &gt; 기업 관리 &gt; 관리
              권한).
            </li>
            <li>
        ...
        <div>
          ...
          <ul className="list-disc space-y-1 pl-5">
            ...
            <li>
              역할 최소 레벨: <b>PL은 레벨 3 이상, PM·부PM은 레벨 4 이상.</b> PM이
              섭외요청·안내문자를 직접 실행해야 하기 때문입니다 — 낮은 레벨을
              지정하려 하면 시스템이 막습니다.
            </li>
            <li>
