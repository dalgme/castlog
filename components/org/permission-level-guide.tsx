...
const LEVEL_ROWS: { level: string; who: string; can: string[] }[] = [
  ...
  },
  {
    ...
    can: [
      ...
      "배정된 프로젝트 안에서 실행 — 섭외요청 발송, 수락서, 품의 상신",
    ],
  },
  {
    level: "레벨 4 · 5 · 6",
    who: "실무 직원 (신규 입사 기본값은 레벨 6)",
    can: [
      "배정된 프로젝트 열람 + 실무 입력",
      "세 레벨의 권한은 서로 같음 — 차이는 결재가 올라가는 순서뿐",
      "예: 레벨 6이 품의를 올리면 레벨 5 → 4 → … 순으로 가까운 상급자에게 감",
    ],
  },
];
